                                    ...
                                    <li key={question.questionId} className="question-item">
                                        ...
                                        {isAdmin && (
                                            <div className="buttons">
                                                <button className="to-options-btn" onClick={() => (setQuestionId(question.questionId), setQuestionText(question.text), navigate(`/options/${question.questionId}`))}>
                                                    Options
                                                </button>
                                                <button
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button className="btn btn-danger" onClick={() => handleDeleteQuestion(deleteQuestionId)} data-bs-dismiss="modal">
                                Delete
                            </button>
                        </div>
                    </div>
