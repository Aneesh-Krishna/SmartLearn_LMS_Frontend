...
import "../styles/MaterialsOverlay.css";

function MaterialsOverlay({ courseId, authToken, adminId, isMaterialsOpen, toggleMaterials }) {
    ...
    return (
        <div className={`gc-materials-overlay ${isMaterialsOpen ? 'open' : ''}`}>
            <div className="gc-materials-content">
                <div className="gc-materials-header">
                    <h2 className="gc-materials-title">Course Materials</h2>
                    <button className="gc-icon-button gc-close-btn" onClick={toggleMaterials}>
                        <span className="material-icons">close</span>
                    </button>
                </div>

                <div className="gc-materials-body">
                    {isAdmin && (
                    ...
                    {loading ? (
                        <div className="gc-loading-materials">
                            <div className="gc-loading-dot"></div>
                            <div className="gc-loading-dot"></div>
                            <div className="gc-loading-dot"></div>
                        </div>
                    ) : materials.length > 0 ? (
                        <ul className="gc-materials-list">
                            {materials.map((material) => (
                                <li key={material.materialId} className="gc-material-item">
                                    <div className="gc-material-info">
                                        <div className="gc-material-icon">
                                            {getFileIcon(material.materialName)}
                                        </div>
                                        <h3 className="gc-material-name">{material.materialName}</h3>
                                    </div>
                                    <div className="gc-material-actions">
                                        <button
                                            className="gc-action-button gc-download-button"
                                        ...
                                        {isAdmin && (
                                            <button
                                                className="gc-action-button gc-delete-button"
                                                onClick={() => {
                        ...
                        <div className="gc-no-materials">
                            <span className="material-icons gc-empty-icon">description</span>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content gc-modal">
                        ...
                        <div className="modal-footer">
                            <button className="gc-button gc-button-text" data-bs-dismiss="modal">Cancel</button>
                            <button
                                className="gc-button gc-danger-button"
...
export default MaterialsOverlay;